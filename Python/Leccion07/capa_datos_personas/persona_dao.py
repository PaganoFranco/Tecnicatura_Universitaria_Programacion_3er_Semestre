...
from capa_datos_personas.curson_def_pool import CursorDelPool
...
if __name__ == '__main__':
    ...
    # persona1 = Persona(1, "Franco", "Pagano", "FrancoP@gmail.com")
    # personas_actualizadas = PersonaDAO.actualizar(persona1)
    # log.debug(f"Personas actualizadas: {personas_actualizadas}")

    # Insertar un registro
    # persona1 = Persona(nombre="Juan", apellido="Perez", email="JuanP@gmail.com")
